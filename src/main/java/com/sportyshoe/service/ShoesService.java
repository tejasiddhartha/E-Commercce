...
import com.sportyshoe.dao.ShoesDao;
	...
	@Autowired
	 private UsersDao userDao;
		...
		public ShoesDataModel getshoesDataByIdService(int seletedShoeId) {
			...
			ShoesDataModel selectedShoesData = shoesDao.getshoeDataById(seletedShoeId);
		...
		public boolean insertNewProductService(int categeory, double price, String name, String imagelink) {
			...
			try {
				...
				ShoesDataModel s = new ShoesDataModel(categeory, categeory, price, name, imagelink);
